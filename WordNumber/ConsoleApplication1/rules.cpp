...
void rules()
{
    ...
    while (!WindowShouldClose())
    {
        ...
        DrawText("MATH GAME: Solve 10 addition problems.", textX, textY, textSize, RAYWHITE);
        DrawText("HANGMAN: Guess the hidden word by", textX, textY + lineGap, textSize, RAYWHITE);
        DrawText("CROSSWORD: Fill in the grid with", textX, textY + 2 * lineGap, textSize, RAYWHITE);
        DrawText("Use the mouse to choose an answer", textX, textY + 3 * lineGap, textSize, RAYWHITE);
        DrawText("answer questions to earn points.", textX, textY + 4 * lineGap, textSize, RAYWHITE);
